# https://github.com/titanium-22/Library/blob/main/BST/AVLTree/AVLTree.py
...
class AVLTree(Generic[T]):
  ...
  def split(self, k: int) -> Tuple["AVLTree", "AVLTree"]:
    l, r = self._split_node(self.node, k)
    return AVLTree([], self.op, self.e, l), AVLTree([], self.op, self.e, r)
