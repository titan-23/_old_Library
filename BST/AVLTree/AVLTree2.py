# https://github.com/titanium-22/Library/blob/main/BST/AVLTree/AVLTree2.py
...
class AVLTree2(Generic[T]):
  ...
  def merge(self, other: "AVLTree2") -> None:
  ...
  def split(self, k: int) -> Tuple["AVLTree2", "AVLTree2"]:
    l, r = self._split_node(self.node, k)
    return AVLTree2(node=l), AVLTree2(node=r)
