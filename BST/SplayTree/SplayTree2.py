# https://github.com/titanium-22/Library/blob/main/BST/SplayTree/SplayTree2.py
...
class SplayTree2(Generic[T]):
  ...
  def merge(self, other: "SplayTree2") -> None:
  ...
  def split(self, p: int) -> Tuple["SplayTree2", "SplayTree2"]:
    if p >= self.__len__():
      return self, SplayTree2()
    self._set_kth_elm_splay(p)
    left = SplayTree2(node=self.node.left)
  ...
  def copy(self) -> "SplayTree2":
    return SplayTree2(self.to_l())
